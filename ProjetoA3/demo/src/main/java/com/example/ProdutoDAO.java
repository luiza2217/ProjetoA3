...
public class ProdutoDAO {
    ...
    public boolean adicionar(Produto produto) {
        String sql = "INSERT INTO produto (nome_produto, id_categoria, quantidade_entrada, quantidade_saida, preco) VALUES (?, ?, ?, ?, ?)";
    ...
    public List<Produto> listar() {
        ...
        String sql = "SELECT id_produto, nome_produto, id_categoria, quantidade_entrada, quantidade_saida, preco FROM produto";
    ...
    public boolean editar(Produto produto) {
        String sql = "UPDATE produto SET nome_produto = ?, id_categoria = ?, quantidade_entrada = ?, quantidade_saida = ?, preco = ? WHERE id_produto = ?";
