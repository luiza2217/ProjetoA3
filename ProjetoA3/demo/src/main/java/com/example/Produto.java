...
public class Produto {
    ...
    public Produto(int id_produto, String nome_produto, int id_categoria, int quantidade_entrada, int quantidade_saida, BigDecimal preco) {
...
public String toString() {
    return "ID: " + id_produto + ", Nome: " + nome_produto + ", Categoria ID: " + id_categoria +
           ", Entrada: " + quantidade_entrada + ", Saída: " + quantidade_saida + ", Preço: " + preco;
}
